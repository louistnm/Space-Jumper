...
public:
    FSM(Transitions transitions, States states, StateType start); //have to have some state
    virtual ~FSM();

    void transition(Transition t, World& world, GameObject& obj); //watch single/plural
